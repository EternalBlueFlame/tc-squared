...
public class EntityBrigadelok080Diesel extends DieselTrain {
     ...
     *     @see #EntityBrigadelok080(World, double, double, double)
     *     The last part defines the unlocalized name, this is used for the item name, entity name, and language file entries.
     */


    public static final Item thisItem = new ItemRollingStock(new EntityBrigadelok080Diesel(null), TiMSquared.MODID, TiMSquared.creativeTab);
     ...
     */
    @Override
    public float transportTopSpeed(){return backwardPressed?30f:70.81f;}
