...
public class ModelBrigadelok_080 extends ModelConverter //Same as Filename
{
    ...
    private void initbodyModel_1() {
        ...
        bodyModel[16] = new ModelRendererTurbo(this, 241, 17, textureX, textureY, StaticModelAnimator.tagSmoke(0)); // chimney tip
        ...
        bodyModel[86] = new ModelRendererTurbo(this, 81, 41, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // axle
        bodyModel[87] = new ModelRendererTurbo(this, 41, 105, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // axle
        bodyModel[88] = new ModelRendererTurbo(this, 81, 121, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // axle
        bodyModel[89] = new ModelRendererTurbo(this, 113, 121, textureX, textureY, StaticModelAnimator.tagSimpleRotate); // axle
        ...
        bodyModel[93] = new ModelRendererTurbo(this, 129, 129, textureX, textureY, StaticModelAnimator.tagConnectingRodOffset(3)); // coupling rod
        bodyModel[94] = new ModelRendererTurbo(this, 241, 89, textureX, textureY, StaticModelAnimator.tagAdvancedPiston); // piston rod
        bodyModel[95] = new ModelRendererTurbo(this, 249, 41, textureX, textureY, StaticModelAnimator.tagCouplingRod); // reverser
        bodyModel[96] = new ModelRendererTurbo(this, 209, 137, textureX, textureY, StaticModelAnimator.tagCouplingRod); // connecting rod
        bodyModel[97] = new ModelRendererTurbo(this, 201, 73, textureX, textureY); // Box 99
        bodyModel[98] = new ModelRendererTurbo(this, 57, 49, textureX, textureY); // Box 100
        bodyModel[99] = new ModelRendererTurbo(this, 57, 81, textureX, textureY); // whistle body
        bodyModel[100] = new ModelRendererTurbo(this, 177, 145, textureX, textureY, StaticModelAnimator.tagConnectingRodOffset(3)); // coupling rod
        bodyModel[101] = new ModelRendererTurbo(this, 137, 97, textureX, textureY, StaticModelAnimator.tagAdvancedPiston); // piston rod
        bodyModel[102] = new ModelRendererTurbo(this, 1, 145, textureX, textureY, StaticModelAnimator.tagCouplingRod); // connecting rod
        bodyModel[103] = new ModelRendererTurbo(this, 66, 153, textureX, textureY, StaticModelAnimator.tagAdvancedPiston); // valve gear rod
        bodyModel[104] = new ModelRendererTurbo(this, 209, 49, textureX, textureY, StaticModelAnimator.tagCouplingRod); // reverser
        bodyModel[105] = new ModelRendererTurbo(this, 201, 81, textureX, textureY); // Box 107
        bodyModel[106] = new ModelRendererTurbo(this, 57, 105, textureX, textureY); // Box 108
        bodyModel[107] = new ModelRendererTurbo(this, 65, 121, textureX, textureY); // Box 109
        bodyModel[108] = new ModelRendererTurbo(this, 209, 57, textureX, textureY); // Box 110
        bodyModel[109] = new ModelRendererTurbo(this, 59, 38, textureX, textureY); // Box 111
        bodyModel[110] = new ModelRendererTurbo(this, 84, 98, textureX, textureY); // Box 111
        bodyModel[111] = new ModelRendererTurbo(this, 45, 153, textureX, textureY, StaticModelAnimator.tagAdvancedPiston); // valve gear rod
        bodyModel[112] = new ModelRendererTurbo(this, 1, 153, textureX, textureY, StaticModelAnimator.tagAdvancedPiston); // valve gear rod
        bodyModel[113] = new ModelRendererTurbo(this, 22, 153, textureX, textureY, StaticModelAnimator.tagAdvancedPiston); // valve gear rod
        bodyModel[114] = new ModelRendererTurbo(this, -1, -1, textureX, textureY, StaticModelAnimator.tagLamp(0,6)); // lamp

        bodyModel[0].addBox(0F, 0F, 0F, 32, 10, 3, 0F); // Box 0
        bodyModel[0].setRotationPoint(-25F, -7F, -1.5F);

        bodyModel[1].addBox(0F, 0F, 0F, 32, 8, 6, 0F); // Box 2
        bodyModel[1].setRotationPoint(-25F, -6F, -3F);

        bodyModel[2].addBox(0F, 0F, 0F, 32, 6, 8, 0F); // Box 3
        bodyModel[2].setRotationPoint(-25F, -5F, -4F);

        bodyModel[3].addBox(0F, 0F, 0F, 32, 3, 10, 0F); // Box 4
        bodyModel[3].setRotationPoint(-25F, -3.5F, -5F);

        bodyModel[4].addBox(0F, 0F, 0F, 8, 6, 18, 0F); // Box 5
        bodyModel[4].setRotationPoint(-23F, -3.5F, -9F);

        bodyModel[5].addBox(0F, 0F, 0F, 22, 7, 18, 0F); // Box 6
        bodyModel[5].setRotationPoint(-15F, -4.5F, -9F);

        bodyModel[6].addBox(0F, 0F, 0F, 2, 3, 3, 0F); // Box 7
        bodyModel[6].setRotationPoint(-15F, -6.01F, -7.5F);

        bodyModel[7].addBox(0F, 0F, 0F, 3, 3, 2, 0F); // Box 8
        bodyModel[7].setRotationPoint(-15.5F, -6F, -7F);

        bodyModel[8].addBox(0F, 0F, 0F, 2, 3, 3, 0F); // Box 9
        bodyModel[8].setRotationPoint(-6.5F, -7F, -7.5F);

        bodyModel[9].addBox(0F, 0F, 0F, 3, 3, 2, 0F); // Box 10
        bodyModel[9].setRotationPoint(-7F, -7.01F, -7F);

        bodyModel[10].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 11
        bodyModel[10].setRotationPoint(-6F, -8F, -6.5F);

        bodyModel[11].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 12
        bodyModel[11].setRotationPoint(-6.5F, -9F, -7F);

        bodyModel[12].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 13
        bodyModel[12].setRotationPoint(-2F, -5F, -7.5F);

        bodyModel[13].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 14
        bodyModel[13].setRotationPoint(3F, -5F, -7.5F);

        bodyModel[14].addBox(0F, 0F, 0F, 3, 1, 3, 0F); // Box 15
        bodyModel[14].setRotationPoint(-24F, -7.5F, -1.5F);

        bodyModel[15].addBox(0F, 0F, 0F, 2, 13, 2, 0F); // Box 16
        bodyModel[15].setRotationPoint(-23.5F, -20F, -1F);

        bodyModel[16].addBox(0F, 0F, 0F, 3, 6, 3, 0F); // chimney tip
        bodyModel[16].setRotationPoint(-24F, -25.5F, -1.5F);

        bodyModel[17].addBox(0F, 0F, 0F, 5, 9, 2, 0F); // Box 18
        bodyModel[17].setRotationPoint(-18F, -15.01F, -1F);

        bodyModel[18].addBox(0F, 0F, 0F, 4, 9, 4, 0F); // Box 19
        bodyModel[18].setRotationPoint(-17.5F, -14.99F, -2F);

        bodyModel[19].addBox(0F, 0F, 0F, 2, 9, 5, 0F); // Box 20
        bodyModel[19].setRotationPoint(-16.5F, -15F, -2.5F);

        bodyModel[20].addBox(0F, 0F, 0F, 5, 13, 3, 0F); // Box 21
        bodyModel[20].setRotationPoint(-9.5F, -19.01F, -1.5F);

        bodyModel[21].addBox(0F, 0F, 0F, 4, 13, 4, 0F); // Box 22
        bodyModel[21].setRotationPoint(-9F, -18.99F, -2F);

        bodyModel[22].addBox(0F, 0F, 0F, 2, 13, 5, 0F); // Box 23
        bodyModel[22].setRotationPoint(-8F, -19F, -2.5F);

        bodyModel[23].addBox(0F, 0F, 0F, 2, 3, 2, 0F); // Box 24
        bodyModel[23].setRotationPoint(-8F, -22F, -1F);

        bodyModel[24].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 25
        bodyModel[24].setRotationPoint(-11F, -20.5F, -0.5F);

        bodyModel[25].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 26
        bodyModel[25].setRotationPoint(-10.5F, -19.5F, -0.5F);

        bodyModel[26].addBox(0F, 0F, 0F, 3, 7, 3, 0F); // Box 27
        bodyModel[26].setRotationPoint(-0.5F, -12.99F, -1.5F);

        bodyModel[27].addBox(0F, 0F, 0F, 4, 7, 2, 0F); // Box 28
        bodyModel[27].setRotationPoint(-1F, -13.01F, -1F);

        bodyModel[28].addBox(0F, 0F, 0F, 2, 7, 4, 0F); // Box 29
        bodyModel[28].setRotationPoint(0F, -13F, -2F);

        bodyModel[29].addBox(0F, 0F, 0F, 1, 2, 5, 0F); // Box 30
        bodyModel[29].setRotationPoint(0.5F, -8F, -2.5F);

        bodyModel[30].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 31
        bodyModel[30].setRotationPoint(-16F, -8F, -3F);

        bodyModel[31].addBox(0F, 0F, 0F, 35, 3, 12, 0F); // Box 32
        bodyModel[31].setRotationPoint(-24F, 4F, -6F);

        bodyModel[32].addBox(0F, 0F, 0F, 1, 2, 20, 0F); // Box 33
        bodyModel[32].setRotationPoint(-25F, 4F, -10F);

        bodyModel[33].addBox(0F, 0F, 0F, 1, 3, 14, 0F); // Box 34
        bodyModel[33].setRotationPoint(-25.5F, 6.5F, -7F);

        bodyModel[34].addBox(0F, 0F, 0F, 4, 2, 12, 0F); // Box 35
        bodyModel[34].setRotationPoint(-24.5F, 7F, -6F);

        bodyModel[35].addBox(0F, 0F, 0F, 3, 5, 18, 0F); // Box 36
        bodyModel[35].setRotationPoint(-21F, 3.5F, -9F);

        bodyModel[36].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 37
        bodyModel[36].setRotationPoint(-19F, 2.5F, -7.5F);

        bodyModel[37].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 38
        bodyModel[37].setRotationPoint(-20.5F, 2.5F, -7.5F);

        bodyModel[38].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 39
        bodyModel[38].setRotationPoint(-20.5F, 2.5F, 6.5F);

        bodyModel[39].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // Box 40
        bodyModel[39].setRotationPoint(-19F, 2.5F, 6.5F);

        bodyModel[40].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 41
        bodyModel[40].setRotationPoint(-24.5F, 9F, -8F);

        bodyModel[41].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 42
        bodyModel[41].setRotationPoint(-27.5F, 7F, -1F);

        bodyModel[42].addBox(0F, 0F, 0F, 1, 3, 3, 0F); // Box 43
        bodyModel[42].setRotationPoint(-28.5F, 6.5F, -1.5F);

        bodyModel[43].addBox(0F, 0F, 0F, 2, 2, 3, 0F); // Box 45
        bodyModel[43].setRotationPoint(-12.5F, -6F, 4.5F);

        bodyModel[44].addBox(0F, 0F, 0F, 3, 2, 2, 0F); // Box 46
        bodyModel[44].setRotationPoint(-13F, -6.01F, 5F);

        bodyModel[45].addBox(0F, 0F, 0F, 1, 25, 16, 0F); // Box 47
        bodyModel[45].setRotationPoint(7F, -20.5F, -8F);

        bodyModel[46].addBox(0F, 0F, 0F, 5, 24, 1, 0F); // Box 48
        bodyModel[46].setRotationPoint(7F, -19.5F, -9F);

        bodyModel[47].addBox(0F, 0F, 0F, 5, 24, 1, 0F); // Box 49
        bodyModel[47].setRotationPoint(7F, -19.5F, 8F);

        bodyModel[48].addBox(0F, 0F, 0F, 1, 29, 18, 0F); // Box 50
        bodyModel[48].setRotationPoint(27F, -20.5F, -9F);

        bodyModel[49].addBox(0F, 0F, 0F, 15, 1, 18, 0F); // Box 51
        bodyModel[49].setRotationPoint(12F, 7.5F, -9F);

        bodyModel[50].addBox(0F, 0F, 0F, 1, 4, 18, 0F); // Box 52
        bodyModel[50].setRotationPoint(11F, 4.5F, -9F);

        bodyModel[51].addBox(0F, 0F, 0F, 4, 1, 16, 0F); // Box 53
        bodyModel[51].setRotationPoint(8F, 3F, -8F);

        bodyModel[52].addBox(0F, 0F, 0F, 9, 12, 1, 0F); // Box 54
        bodyModel[52].setRotationPoint(12F, -4.5F, 8F);

        bodyModel[53].addBox(0F, 0F, 0F, 9, 12, 1, 0F); // Box 55
        bodyModel[53].setRotationPoint(12F, -4.5F, -9F);

        bodyModel[54].addBox(0F, 0F, 0F, 23, 1, 10, 0F); // Box 56
        bodyModel[54].setRotationPoint(6F, -22.5F, -5F);

        bodyModel[55].addBox(0F, 0F, 0F, 23, 1, 3, 0F); // Box 57
        bodyModel[55].setRotationPoint(6F, -21.5F, -8F);

        bodyModel[56].addBox(0F, 0F, 0F, 23, 1, 3, 0F); // Box 58
        bodyModel[56].setRotationPoint(6F, -21.5F, 5F);

        bodyModel[57].addBox(0F, 0F, 0F, 23, 1, 2, 0F); // Box 59
        bodyModel[57].setRotationPoint(6F, -20.5F, 8F);

        bodyModel[58].addBox(0F, 0F, 0F, 23, 1, 2, 0F); // Box 60
        bodyModel[58].setRotationPoint(6F, -20.5F, -10F);

        bodyModel[59].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 61
        bodyModel[59].setRotationPoint(7F, -21.5F, -5F);

        bodyModel[60].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 62
        bodyModel[60].setRotationPoint(27F, -21.5F, -5F);

        bodyModel[61].addBox(0F, 0F, 0F, 5, 2, 6, 0F); // Box 63
        bodyModel[61].setRotationPoint(16F, -24.5F, -3F);

        bodyModel[62].addBox(0F, 0F, 0F, 7, 1, 7, 0F); // Box 64
        bodyModel[62].setRotationPoint(15F, -25.5F, -3.5F);

        bodyModel[63].addBox(0F, 0F, 0F, 7, 1, 4, 0F); // Box 65
        bodyModel[63].setRotationPoint(15F, -26.5F, -2F);

        bodyModel[64].addBox(0F, 0F, 0F, 6, 11, 10, 0F); // Box 66
        bodyModel[64].setRotationPoint(8F, -4F, -5F);

        bodyModel[65].addBox(0F, 0F, 0F, 6, 2, 7, 0F); // Box 67
        bodyModel[65].setRotationPoint(7.5F, -6F, -3.5F);

        bodyModel[66].addBox(0F, 0F, 0F, 5, 1, 4, 0F); // Box 68
        bodyModel[66].setRotationPoint(7.5F, -7F, -2F);

        bodyModel[67].addBox(0F, 0F, 0F, 4, 2, 12, 0F); // Box 69
        bodyModel[67].setRotationPoint(7F, 7F, -6F);

        bodyModel[68].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 71
        bodyModel[68].setRotationPoint(4F, 7F, -6F);

        bodyModel[69].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 72
        bodyModel[69].setRotationPoint(4F, 7F, 5F);
        ...
        bodyModel[71].setRotationPoint(-2F, 7F, 5F);

        bodyModel[72].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 75
        bodyModel[72].setRotationPoint(-14F, 7F, -6F);

        bodyModel[73].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 76
        bodyModel[73].setRotationPoint(-14F, 7F, 5F);

        bodyModel[74].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 77
        bodyModel[74].setRotationPoint(-8F, 7F, 5F);

        bodyModel[75].addBox(0F, 0F, 0F, 5, 2, 1, 0F); // Box 78
        bodyModel[75].setRotationPoint(-8F, 7F, -6F);

        bodyModel[76].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 79
        bodyModel[76].setRotationPoint(-18F, 7F, -6F);

        bodyModel[77].addBox(0F, 0F, 0F, 3, 2, 1, 0F); // Box 80
        bodyModel[77].setRotationPoint(-18F, 7F, 5F);

        bodyModel[78].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[78].setRotationPoint(-14.5F, 7.5F, -5F);

        bodyModel[79].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[79].setRotationPoint(-8.5F, 7.5F, -5F);

        bodyModel[80].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[80].setRotationPoint(3.5F, 7.5F, -5F);

        bodyModel[81].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[81].setRotationPoint(-2.5F, 7.5F, -5F);

        bodyModel[82].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[82].setRotationPoint(3.5F, 7.5F, 5F);

        bodyModel[83].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[83].setRotationPoint(-2.5F, 7.5F, 5F);

        bodyModel[84].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[84].setRotationPoint(-8.5F, 7.5F, 5F);

        bodyModel[85].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // wheel
        bodyModel[85].setRotationPoint(-14.5F, 7.5F, 5F);

        bodyModel[86].addBox(-0.5F, -0.5F, 0F, 1, 1, 13, 0F); // axle
        bodyModel[86].setRotationPoint(3.5F, 7.5F, -6.5F);

        bodyModel[87].addBox(-0.5F, -0.5F, 0F, 1, 1, 13, 0F); // axle
        bodyModel[87].setRotationPoint(-2.5F, 7.5F, -6.5F);

        bodyModel[88].addBox(-0.5F, -0.5F, 0F, 1, 1, 13, 0F); // axle
        bodyModel[88].setRotationPoint(-8.5F, 7.5F, -6.5F);

        bodyModel[89].addBox(-0.5F, -0.5F, 0F, 1, 1, 13, 0F); // axle
        bodyModel[89].setRotationPoint(-14.5F, 7.5F, -6.5F);

        bodyModel[90].addBox(0F, 0F, 0F, 16, 1, 12, 0F); // Box 93
        bodyModel[90].setRotationPoint(11F, 8F, -6F);

        bodyModel[91].addBox(0F, 0F, 0F, 30, 1, 11, 0F); // Box 94
        bodyModel[91].setRotationPoint(-23F, 2.5F, -5.5F);

        bodyModel[92].addBox(0F, 0F, 0F, 30, 1, 9, 0F); // Box 95
        bodyModel[92].setRotationPoint(-23F, 3.5F, -4.5F);

        bodyModel[93].addBox(-9.5F, -0.5F, -0.5F, 19, 1, 1, 0F); // coupling rod
        bodyModel[93].setRotationPoint(-5.5F, 7F, 7F);

        bodyModel[94].addBox(-9F, -0.5F, -0.5F, 4, 1, 1, 0F); // piston rod
        bodyModel[94].setRotationPoint(-10.5F, 6.5F, 7.5F);

        bodyModel[95].addBox(-1F, 0F, -0.5F, 1, 4, 1, 0F); // reverser
        bodyModel[95].setRotationPoint(-9.5F, 3F, 8F);

        bodyModel[96].addBox(-7F, -0.5F, -0.5F, 14, 1, 1, 0F); // connecting rod
        bodyModel[96].setRotationPoint(-8.75F, 7F, 7.5F);
        bodyModel[96].rotateAngleZ = 6.20900881F;

        bodyModel[97].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 99
        bodyModel[97].setRotationPoint(4F, -17.5F, -0.5F);

        bodyModel[98].addBox(0F, 0F, 0F, 1, 8, 1, 0F); // Box 100
        bodyModel[98].setRotationPoint(4F, -25.5F, -0.5F);

        bodyModel[99].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // whistle body
        bodyModel[99].setRotationPoint(3.5F, -24.5F, -1F);

        bodyModel[100].addBox(-9.5F, -0.5F, -0.5F, 19, 1, 1, 0F); // coupling rod
        bodyModel[100].setRotationPoint(-5.5F, 7F, -7F);

        bodyModel[101].addBox(-9F, -0.5F, -0.5F, 4, 1, 1, 0F); // piston rod
        bodyModel[101].setRotationPoint(-10.5F, 6.5F, -7.5F);

        bodyModel[102].addBox(-7F, -0.5F, -0.5F, 14, 1, 1, 0F); // connecting rod
        bodyModel[102].setRotationPoint(-8.75F, 7F, -7.5F);
        bodyModel[102].rotateAngleZ = 6.20900881F;

        bodyModel[103].addBox(-9F, -0.5F, -0.5F, 10, 1, 1, 0F); // valve gear rod
        bodyModel[103].setRotationPoint(-10.5F, 5.5F, -7.5F);
        bodyModel[103].rotateAngleZ = 6.19591884F;

        bodyModel[104].addBox(-1F, 0F, -0.5F, 1, 4, 1, 0F); // reverser
        bodyModel[104].setRotationPoint(-9.5F, 3F, -8F);

        bodyModel[105].addBox(-1F, 0F, -0.5F, 1, 1, 3, 0F); // Box 107
        bodyModel[105].setRotationPoint(-9.5F, 3F, 5F);

        bodyModel[106].addBox(-1F, 0F, -0.5F, 1, 1, 3, 0F); // Box 108
        bodyModel[106].setRotationPoint(-9.5F, 3F, -7F);

        bodyModel[107].addBox(0F, 0F, 0F, 13, 1, 1, 0F); // Box 109
        bodyModel[107].setRotationPoint(-6F, -7F, 3.5F);

        bodyModel[108].addBox(0F, 0F, 0F, 2, 2, 1, 0F); // Box 110
        bodyModel[108].setRotationPoint(-8F, -7F, 3F);
        bodyModel[108].rotateAngleX = 0.78539816F;

        bodyModel[109].addBox(0F, 0F, 0F, 1, 3, 3, 0F); // Box 111
        bodyModel[109].setRotationPoint(-26.5F, 6.5F, -1.5F);

        bodyModel[110].addBox(0F, 0F, 0F, 3, 2, 2, 0F); // Box 111
        bodyModel[110].setRotationPoint(28F, 5.5F, -1F);

        bodyModel[111].addBox(-9F, -0.5F, -0.5F, 9, 1, 1, 0F); // valve gear rod
        bodyModel[111].setRotationPoint(-1.5F, 7.5F, -7.25F);
        bodyModel[111].rotateAngleZ = 5.89921287F;

        bodyModel[112].addBox(-9F, -0.5F, -0.5F, 9, 1, 1, 0F); // valve gear rod
        bodyModel[112].setRotationPoint(-1.5F, 7.5F, 7.25F);
        bodyModel[112].rotateAngleZ = 5.89921287F;

        bodyModel[113].addBox(-9F, -0.5F, -0.5F, 10, 1, 1, 0F); // valve gear rod
        bodyModel[113].setRotationPoint(-10.5F, 5.5F, 7.5F);
        bodyModel[113].rotateAngleZ = 6.19591884F;

        bodyModel[114].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // lamp
        bodyModel[114].setRotationPoint(-25F, -8F, -0.5F);
    }
}